  ...
  return (
    ...
    >
      ...
      <div className="bg-[#16b6bc2d] p-6">
        <h2 className="text-lg font-semibold mb-4 bg-[#16b6bc43] px-2 lg:px-4 md:px-4 lg:text-center md:text-center mr-52 lg:mr-52 md:mr-49 py-1 rounded-md">{product.brand}</h2>
        ...
        <div className="grid grid-cols-2 gap-52 mb-6">
          <div>
